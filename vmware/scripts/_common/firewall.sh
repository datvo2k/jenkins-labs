...
function installPackages() {
    ...
    # Uncomment the line that sets the 'CRON_DAILY_RUN' variable to 'yes' in the '/etc/default/aide' file
    sed -i 's/#CRON_DAILY_RUN=yes/CRON_DAILY_RUN=yes/' /etc/default/aide >/dev/null 2>&1
